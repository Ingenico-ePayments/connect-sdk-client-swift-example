...
class SummaryTableHeaderView: UIView {
    ...
    override init(frame: CGRect) {
        ...
        let securePaymentIcon = UIImageView(frame: CGRect(x: CGFloat(0), y: CGFloat(0), width: CGFloat(10), height: CGFloat(10)))
        ...
        securePaymentLabel.textColor = UIColor(red: CGFloat(0), green: CGFloat(0.8), blue: CGFloat(0), alpha: CGFloat(1))
        ...
        banner.backgroundColor = UIColor(red: CGFloat(0.95), green: CGFloat(0.95), blue: CGFloat(0.95), alpha: CGFloat(1))
