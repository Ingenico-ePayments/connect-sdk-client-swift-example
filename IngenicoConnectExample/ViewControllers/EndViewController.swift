...
class EndViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        resultButton = Button(type: .secondary)
        container.addSubview(resultButton)
        let encryptedDataButtonTitle =
            NSLocalizedString(
                "EncryptedDataResultLabel",
                tableName: AppConstants.kAppLocalizable,
                bundle: AppConstants.appBundle,
                value: "",
                comment: ""
        ...
        constraints =
            NSLayoutConstraint.constraints(
                withVisualFormat: "|-[encryptedText]-|",
                options: [],
                metrics: nil,
                views: viewMapping
            )
        ...
        constraints =
            NSLayoutConstraint.constraints(
                withVisualFormat:
                    "V:|-[label]-(20)-[textView(115)]-(20)-[button]-(50)-[resultButton]-(20)-[encryptedText(250)]",
                options: [],
                metrics: nil,
                views: viewMapping
            )
